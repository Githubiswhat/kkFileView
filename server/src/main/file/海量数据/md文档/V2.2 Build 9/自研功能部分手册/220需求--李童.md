...
```
  create user user1 identified by 'vastbase@123';
  create user user2 identified by 'vastbase@123';
  create user user3 identified by 'vastbase@123';
  create user user4 identified by 'vastbase@123';
  create user user5 identified by 'vastbase@123';
  create user user6 identified by 'vastbase@123';
  create user user7 identified by 'vastbase@123';
  create user user8 identified by 'vastbase@123';
  create user user9 identified by 'vastbase@123';
